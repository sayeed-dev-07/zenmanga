...
const AllManga = () => {
    ...
    return (
        <div className='w-full px-[2%] md:px-[5%] lg:px-[10%] my-[2%] flex-wrap mx-auto '>
            ...
            <motion.div viewport={{once:true}} key={curPage} variants={parent} initial='hidden' whileInView='show' className='grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 md:gap-x-6 gap-y-6'>
                {currData.map(item => 
                    <motion.div viewport={{once:true}} variants={child} key={item.id}>
