...
const TagsManga = () => {
    ...
    return (
        <div className='w-full px-[2%] md:px-[5%] lg:px-[10%] my-[2%]  mx-auto '>
            ...
            <motion.div key={filterArr} transition={{duration:0.4}}  variants={parent} initial='hidden' animate='show' className='grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 md:gap-x-6 gap-y-6'>
